...
class SearchAdapter @Inject constructor() : PagingDataAdapter< ResponseRecipes.Result ,SearchAdapter.ViewHolder>(
    differCallback) {
    ...
    companion object {
        val differCallback = object : DiffUtil.ItemCallback<ResponseRecipes.Result>() {
            override fun areItemsTheSame(oldItem: ResponseRecipes.Result, newItem: ResponseRecipes.Result): Boolean {
                return oldItem.id == newItem.id
            }

            override fun areContentsTheSame(oldItem: ResponseRecipes.Result, newItem: ResponseRecipes.Result): Boolean {
