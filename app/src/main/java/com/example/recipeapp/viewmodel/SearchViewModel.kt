...
import javax.inject.Inject
    ...
    @HiltViewModel
    class SearchViewModel @Inject constructor(private val searchRepository: SearchRepository,private val searchMenuRepository: SearchMenuRepository) : ViewModel() {
